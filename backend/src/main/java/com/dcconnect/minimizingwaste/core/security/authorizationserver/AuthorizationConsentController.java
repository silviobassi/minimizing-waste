...
public class AuthorizationConsentController {
    ...
    public String consent(
        ...
        Set<String> scopesToApprovePreviously;
        if (consent != null) {
            scopesToApprovePreviously = consent.getScopes();
            scopesToApprove.removeAll(scopesToApprovePreviously);
        } else {
            scopesToApprovePreviously = Collections.emptySet();
        }
        ...
        model.addAttribute("scopesToApprovePreviously", scopesToApprovePreviously);
