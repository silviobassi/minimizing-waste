...
export namespace User {
  export type PagedModelDetailed = MinimizingWaste.components['schemas']['PagedModelUserDetailedModel'];
  ...
  export type UpdateInput = MinimizingWaste.components['schemas']['UserUpdateInput']
